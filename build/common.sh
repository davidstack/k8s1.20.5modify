...
readonly KUBE_DOCKER_REGISTRY="${KUBE_DOCKER_REGISTRY:-registry.cn-hangzhou.aliyuncs.com/google_containers}"
readonly KUBE_BASE_IMAGE_REGISTRY="${KUBE_BASE_IMAGE_REGISTRY:-registry.cn-hangzhou.aliyuncs.com/google_containers/build-image}"
