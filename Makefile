...
#   KUBE_DOCKER_REGISTRY: Registry of released images, default to registry.cn-hangzhou.aliyuncs.com/google_containers
#   KUBE_BASE_IMAGE_REGISTRY: Registry of base images for controlplane binaries, default to registry.cn-hangzhou.aliyuncs.com/google_containers
#
# Example:
